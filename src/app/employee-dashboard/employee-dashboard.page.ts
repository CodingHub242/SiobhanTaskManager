...
import { briefcase,add, trash, create, mail, document, close, eye, download, checkmark, arrowBack, arrowUp, arrowDown, filter, cloudUpload, checkmarkCircle, layers, time, serverOutline, person, logOut, ellipsisVertical } from 'ionicons/icons';
...
export class EmployeeDashboardPage implements OnInit {
  ...
  constructor(  private authService: AuthService,
    ...
    private toastController: ToastController) {
       addIcons({briefcase,ellipsisVertical,serverOutline, add,person,logOut, trash, create, mail, document, close, eye, download, checkmark, arrowBack, arrowUp, arrowDown, filter,checkmarkCircle,cloudUpload,layers,time});
  }
